...
public class BlockTagDataGenerator extends BlockTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        this.tag(BlockTags.MINEABLE_WITH_PICKAXE).add(
                ...
                BlockRegistry.CUT_WEATHERED_SANDSTONE_SLAB.get(),
                ...
                BlockRegistry.SMOOTH_WEATHERED_SANDSTONE_SLAB.get(),
                BlockRegistry.SMOOTH_WEATHERED_SANDSTONE_STAIRS.get(),
                BlockRegistry.WEATHERED_SANDSTONE.get(),
                BlockRegistry.WEATHERED_SANDSTONE_SLAB.get(),
                BlockRegistry.WEATHERED_SANDSTONE_STAIRS.get(),
                BlockRegistry.WEATHERED_SANDSTONE_BRICKS.get(),
                BlockRegistry.WEATHERED_SANDSTONE_BRICK_SLAB.get(),
                BlockRegistry.WEATHERED_SANDSTONE_BRICK_STAIRS.get()
        );
        ...
        this.tag(BlockTags.WALLS).add(
                ...
                BlockRegistry.WEATHERED_SANDSTONE_WALL.get(),
                BlockRegistry.WEATHERED_SANDSTONE_BRICK_WALL.get()
        );

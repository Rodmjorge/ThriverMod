...
public class MapDecorationTypeRegistry {

    public static final DeferredRegister<MapDecorationType> MAP_DECORATION =
            DeferredRegister.create(BuiltInRegistries.MAP_DECORATION_TYPE, RenovayMod.MOD_ID);
    ...
    private static Holder<MapDecorationType> register(String name, String assetId, boolean showOnItemFrame, int mapColor,
        ...
        return MAP_DECORATION.register(name, () -> new MapDecorationType(RenovayMod.createLoc(assetId),

package net.rodmjorgeh.renovay.sound;
...
public class SoundEventRegistry {
    ...
    public static final DeferredRegister<SoundEvent> SOUND =
            DeferredRegister.create(BuiltInRegistries.SOUND_EVENT, RenovayMod.MOD_ID);

    public static final Supplier<SoundEvent> REED_FLUTE_PLAY = register("item.reed_flute.play");


    private static Supplier<SoundEvent> register(String name) {
        ResourceLocation loc = RenovayMod.createLoc(name);
